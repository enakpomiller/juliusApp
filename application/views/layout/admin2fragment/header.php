                                    ...
                                    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    <h4 class="text-white mb-0"><?=(ucfirst($this->session->firstname))."  ".(ucfirst($this->session->lastname)) ?> (<?=$this->session->usertype?> )</h4>
                                        ...
                                        <div class="p-4">
                                            ...
                                            <a class="dropdown-item d-flex nav-link" href="<?=base_url('sellers/viewproducts')?>">
                                                ...
                                                <i class="fa fa-compass pr-2 text-warning"></i> Logout</a>
